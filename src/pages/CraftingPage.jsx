  ...
  const { data: userLoot = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (!user) {
        ...
        return await base44.entities.Loot.list('-obtainedAt', 1000);
      }
    },
    staleTime: 30000
  });
  ...
  if (craftedLoot) {
    return (
      <div className="min-h-screen p-4" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div 
          className="max-w-md mx-auto mt-20 p-8 transform animate-bounce-in"
          style={{
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-6">
          ...
          >
            ...
            {language === 'zh' ? '返回宝物库' : 'Back to Treasures'}
          </button>
          ...
          <div className="text-center">
            ...
            <h1 className="text-3xl font-black uppercase mb-2">{t('crafting_title')}</h1>
            <p className="font-bold text-sm mb-4" style={{ color: 'var(--text-secondary)' }}>
              {t('crafting_subtitle')}
            </p>
            ...
            {!user && (
              ...
              >
                <p className="font-black text-sm text-center" style={{ color: 'var(--text-primary)' }}>
                  ⚠️ {language === 'zh' 
            ...
            <div className="grid grid-cols-3 gap-3">
              {['Rare', 'Epic', 'Legendary'].map(rarity => (
                <button
                  ...
                  style={{
                    backgroundColor: targetRarity === rarity ? rarityColors[rarity].bg : 'var(--bg-primary)',
                    color: targetRarity === rarity ? rarityColors[rarity].text : 'var(--text-primary)',
                ...
                {availableLoot.map(item => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        backgroundColor: isSelected ? '#4ECDC4' : 'var(--bg-secondary)',
