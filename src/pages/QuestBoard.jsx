      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="flex gap-3 mb-3">
            ...
            >
              <Gift className="w-10 h-10" strokeWidth={3} style={{ color: '#FFF' }} />
            </Button>
            ...
            >
              {isProcessing ? (
                <Loader2 className="w-10 h-10 animate-spin" style={{ color: '#FFF' }} />
              ) : (
                <Sparkles className="w-10 h-10" strokeWidth={3} style={{ color: '#FFF', fill: 'none' }} />
              )}
            </Button>
          </div>
