    ...
    if (newActionHint.trim()) {
      try {
        const result = await base44.integrations.Core.InvokeLLM({
          prompt: `你是【星陨纪元冒险者工会】的首席史诗书记官——精通奇幻传说的智者。

【任务描述】："${newActionHint}"

【你的使命】：
将这个委托转化为**充满奇幻色彩和史诗气息的冒险任务**！

【命名原则】：
1. **格式**：【任务类型】+ 奇幻画面感标题
2. **任务类型**：讨伐、狩猎、探索、调查、收集、采集、修炼、试炼、护送、救援、谈判等
3. **标题必须包含**：
   - 奇幻地点（幽影森林、灼热荒原、秘银矿洞、星陨平原）
   - 时间意象（破晓、黄昏、子夜、晨曦）
   - 奇幻元素（魔晶、符文、灵药、元素之力）
4. **彻底奇幻化**：
   - ❌ 超市 → ✓ 月光集市/商会货栈
...
【极致RPG示例】：
❌ 普通："【修炼】晨跑"
✓ **史诗级**："【修炼】破晓风语者：晨曦平原的疾行修行"

❌ 普通："【收集】买菜"  
✓ **史诗级**："【采集】月光集市：寻觅灵蕴食材的晨曦之旅"

❌ 普通："【学习】读书"
✓ **史诗级**："【探索】古老典籍：智慧圣殿的秘密探寻"
