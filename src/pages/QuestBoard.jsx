      ...
      try {
        ...
        if (nextDayPlanned.length > 0 && lastPlanned && lastPlanned < today) {
          ...
          try {
            ...
            // 如果出错，不清空 nextDayPlannedQuests，保留数据
            alert(language === 'zh' 
